...
t2v_util.t2valert =
{
    showAlert: function (content,title,execWhenClose) {
        ...
        $("#dialog-confirm").dialog({ title: title, buttons: [{ text: "OK", class: "btn05", click: function () { $(this).dialog("close"); if (execWhenClose != undefined) execWhenClose(); } }] });
...
t2v_util.t2vconfirm =
{
    showConfirm: function (content, OkMethod, CancelMethod,title) {
        ...
        $("#dialog-confirm").dialog({ title: title, buttons: [{ text: "YES", class: "btn05", click: function () { $(this).dialog("close"); OkMethod(); } }, { text: "NO", class: "btn05", click: function () { $(this).dialog("close"); CancelMethod(); } }] });
        $("#dialog-confirm").dialog("open");
    }
};
...
t2v_util.t2vmenu = {
    switchMenu: function(curr_id, total_num){
