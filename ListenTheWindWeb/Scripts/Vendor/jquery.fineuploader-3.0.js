...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            ...
            noUploadType: "Please select a type.",
            existCreaditNote: "Createdit Note have already exist.",
            PriceBookInfo:"Please select Type and ProductLine.",
            onLeave: "The files are being uploaded, if you leave now the upload will be cancelled.",
            duplicatePartNumber: "There are duplicate part numbers in this file, please correct it and upload again."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploaderBasic.prototype = {
    ...
    _createUploadButton: function(element){
        ...
        var button = new qq.UploadButton({
            ...
            hoverClass: this._options.effects.buttonHover,
            focusClass: this._options.effects.buttonFocus,
...
qq.FineUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader" title = "Upload file">' +
        ...
        showMessage: function(message, fileName){
            if (fileName != "") {
                $("#divUploadDataArea").html(message);
            }
            else {
                t2v_util.t2valert.showAlert(message);
            //alert(message);
            }
        }
    }, true);
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _controlFailureTextDisplay: function(item, response) {
        ...
        if (mode === 'custom') {
            ...
            if(response.flag != undefined && response.flag == "-1")
            {
                //qq(this._find(item, 'statusText')).setText("format of csv file is not correct.");
                $("#divUploadError").html("format of csv file is not correct.");
            }
            if(response.flag != undefined && response.flag == "-2")
            {
                //this._error("duplicatePartNumber", "");
                $("#divUploadError").html("There are duplicate part numbers in this file, please correct it and upload again.");
                //qq(this._find(item, 'statusText')).setText("There are duplicate part number in file, please correct it and upload again.");
            }
            else{
                $("#divUploadError").html(this._options.text.failUpload);
